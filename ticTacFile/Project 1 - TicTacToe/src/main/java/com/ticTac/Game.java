...
public class Game {
    ...
    public String checkGameWinner(char [][]grid){
        String result = "None";
        char x ='x', y = 'o';
        if (x == grid[0][0] && x == grid[1][0] && x == grid[2][0] ||
                x == grid[0][1] && x == grid[1][1] && x == grid[2][1] ||
                x == grid[0][2] && x == grid[1][2] && x == grid[2][2] ||
                x == grid[0][0] && x == grid[0][1] && x == grid[0][2] ||
                x == grid[1][0] && x == grid[1][1] && x == grid[1][2] ||
                x == grid[2][0] && x == grid[2][1] && x == grid[2][2] ||
                x == grid[0][0] && x == grid[1][1] && x == grid[2][2] ||
                x == grid[0][2] && x == grid[1][1] && x == grid[2][0])  {

            result = "X Wins!";
        }
        else if (y == grid[0][0] && y == grid[1][0] && y == grid[2][0] ||
                y == grid[0][1] && y == grid[1][1] && y == grid[2][1] ||
                y == grid[0][2] && y == grid[1][2] && y == grid[2][2] ||
                y == grid[0][0] && y == grid[0][1] && y == grid[0][2] ||
                y == grid[1][0] && y == grid[1][1] && y == grid[1][2] ||
                y == grid[2][0] && y == grid[2][1] && y == grid[2][2] ||
                y == grid[0][0] && y == grid[1][1] && y == grid[2][2] ||
                y == grid[0][2] && y == grid[1][1] && y == grid[2][0] ) {
